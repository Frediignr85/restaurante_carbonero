<?php
    ...
    $joinQuery = " FROM tblUsuario LEFT JOIN tblEmpleado on tblEmpleado.id_empleado = tblUsuario.id_empleado_usuario INNER JOIN tblcargos on tblcargos.id_cargo = tblUsuario.id_tipo_usuario_USU";
