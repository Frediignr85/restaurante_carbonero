            ...
            <?php
				...
				for($i=0;$i<$numrows;$i++)
				{
					...
					if($admin=='1')
					{
						...
						tblmodulo.id_modulo, tblmodulo.nombre as nombremodulo, tblmodulo.descripcion, tblmodulo.filename, tblusuario.id_tipo_usuario_USU
						FROM tblmenu, tblmodulo, tblusuario
						WHERE tblusuario.id_usuario='$id_user'
						AND tblusuario.id_tipo_usuario_USU='1'
					...
					else
					{
						...
						tblusuario_modulo.id_usuario,tblusuario.id_tipo_usuario_USU
