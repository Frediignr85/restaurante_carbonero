...
if($_POST){
    ...
    $sql = "SELECT tblusuario.id_usuario, tblusuario.nombre, tblusuario.usuario, tblusuario.password, tblusuario.id_tipo_usuario_USU, tblempleado.id_sucursal_EMP FROM tblusuario INNER JOIN tblempleado on tblempleado.id_empleado = tblusuario.id_empleado_usuario  WHERE tblusuario.usuario = '$user' AND tblusuario.password ='$pass' AND tblusuario.deleted is NULL";
    $result = _query($sql);
	...
	if($num > 0)
	{
		...
		$_SESSION["admin"] = $row['id_tipo_usuario_USU'];
