...
$(document).ready(function() {
  ...
  $('#formulario').validate({
    ...
    messages: {
      ...
      nombre_legal: "Ingrese el nombre legal",
      direccion: "Ingrese la direccion",
      nombre_contacto: "Ingrese el nombre del contacto"
    },
...
function desactivarProveedor(id_proveedor, estado){
  if(estado == 1)
  {
    var text = "Desactivar";
  }
...
function generar2(){
	...
	dataTable = $('#editable2').DataTable( {
      ...
      "processing": true,      
			...
			"serverSide": true,
			"ajax":{
					url :"admin_proveedor_dt.php", // json datasource
