$(document).ready(function()
{
	...
	$('#formulario_paciente').validate(
	{
	    rules:
	    {
            ...
            {
				required: true,
				regexp: /^[a-zA-ZáéíóúàèìòùÀÈÌÒÙÁÉÍÓÚñÑüÜ ]+$/
            },
			apellido:
			{
				required: true,
            ...
            {
				required: true,
				regexp: /^[a-zA-ZáéíóúàèìòùÀÈÌÒÙÁÉÍÓÚñÑüÜ0-9\s,'-]*$/
            },
            tipo:
            {
				required: true
        ...
        messages:
        {
			nombre: 
			{
				...
				regexp: "El nombre del paciente solo debe de contener letras."			
			},
			apellido: 
			{
				required:"Por favor ingrese el apellido del paciente",
				regexp: "El apellido del paciente solo debe de contener letras."
			},
			sexo: 
			{
			...
			telefono1: {
				...
				regexp: "El teléfono #1 del paciente solo debe de contener numeros."
			},
			fecha: {
				required:"Por favor ingrese la fecha de nacimiento",
				regexp: "El teléfono #2 del paciente solo debe de contener letras."
			},
			departamento: {
				equired:"Por favor seleccione un departamento",
			},
			municipio: {
				required:"Por favor seleccione un municipio",
			},
			direccion: {
				required:"Por favor ingrese la dirección del paciente",
				regexp: "La dirección donde reside el paciente solo debe de contener letras, numeros."
			},
			tipo: {
				required:"Por favor seleccione la forma de notificación"
			},
			email:{
