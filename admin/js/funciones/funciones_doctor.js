$(document).ready(function()
{
	...
	function senddata()
	{
		...
		var dataString ='process='+process+'&id_doctor='+id_doctor;
		dataString+='&email='+email+'&jvpm='+jvpm+"&usuario="+usuario+"&id_secretaria="+id_secretaria;
		dataString+='&especialidad='+especialidad+'&subespecialidad='+subespecialidad+'&honorario='+honorario;
		$.ajax({
			type:'POST',
			url:urlprocess,
			data: dataString,
