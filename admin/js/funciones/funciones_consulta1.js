...
function agregar_examen(id, nombre) {
  var dataString = "process=examen&id="+id+"&nombre="+nombre+"&id_cita=" + $("#id_cita").val();
  $.ajax({
    type: 'POST',
    url: url_proc,
    data: dataString,
...
$(document).on("click",".imp_electro", function()
{
  var id_cita = $("#id_cita").val();
  var url_electro = $("#url_electro").val();
  guardar_otros();
  var cadena = url_electro+"?id_cita="+id_cita;
  window.open(cadena, '', '');
})
...
function guardar_otros() {
  ...
  var ritmo = $("#ritmo").val();
  var f_cardiaca = $("#f_cardiaca").val();
  var eje_corazon = $("#eje_corazon").val();
  var intervalo_qt = $("#intervalo_qt").val();
  var intervalo_pr = $("#intervalo_pr").val();
  var qrs = $("#qrs").val();
  var isquemia = $("#isquemia").val();
  ...
  var pulmon = $("#pulmon").val();
  var corazon = $("#corazon").val();
  var abdomen = $("#abdomen").val();
  var mi = $("#mi").val();
  var neurologia = $("#neurologico").val();
  ...
  dataString += "&motivo=" + motivo + "&t_o=" + t_o + "&ta=" + ta + "&p=" + p + "&peso=" + peso + "&fr=" + fr + "&fo=" + fo + "&talla=" + talla + "&imc=" + imc+ "&pa=" + pa;
  dataString += "&id_paciente=" + id_paciente + "&id_doctor=" + id_doctor;
  dataString += "&cabeza=" + cabeza + "&cuello=" + cuello + "&pulmon=" + pulmon + "&corazon=" + corazon + "&abdomen=" + abdomen + "&mi=" + mi + "&neurologia=" + neurologia;
  dataString += "&ritmo=" + ritmo + "&f_cardiaca=" + f_cardiaca + "&eje_corazon=" + eje_corazon + "&intervalo_qt=" + intervalo_qt + "&intervalo_pr=" + intervalo_pr + "&qrs=" + qrs + "&isquemia=" + isquemia + "&bloqueo=" + bloqueo + "&observaciones=" + observaciones + "&recomendaciones=" + recomendaciones;
  $.ajax({
    type: 'POST',
    url: url_proc,
    data: dataString,
