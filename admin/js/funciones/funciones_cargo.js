...
function senddata()
{
	...
	{
		var id_usuario=0;
		var urlprocess='agregar_cargo.php';
	...
	if(process=='edited')
	{
		...
		var urlprocess='editar_cargo.php';
...
function generar2(){
	...
	dataTable = $('#editable2').DataTable( {
			...
			"serverSide": true,
			"ajax":{
					url :"admin_cargo_dt.php", // json datasource
