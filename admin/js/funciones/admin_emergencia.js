var urlprocess='agregar_insumos_recepcion.php';
...
$(document).ready(function() {
    ...
    $("#producto_buscar").typeahead({
        ...
        updater: function(selection) {
            ...
            $.ajax({
                type: 'POST',
                url: 'agregar_insumos_recepcion.php',
                data: {
...
$(document).on('change', '.sel', function(event) {
    ...
    $.ajax({
        ...
        type: 'POST',
        dataType: 'json',
        data: 'process=get_presentancion' + "&id_presentacion=" + id_presentacion+ "&id_recepcion=" + idRecepcion,
        success: function(data){
