var urlprocess='edit_insumos_micro.php';
...
function traer_insumos(id_mic_pte){
  id_mic_pte = id_mic_pte? id_mic_pte : '';
 ...
 var n=0;
  $.ajax({
    ...
    data: {
      ...
      id_microcirugia_pte: id_mic_pte,
    },
    dataType: 'json',
    success: function(datos) {
      $.each(datos, function(key, value){
        ...
        addProductList(id_prod, tipo, descr,cant);
      });
...
function addProductList(id_prod, tipo, descr,cantx=0) {
	...
	$.ajax({
      ...
      if(cantx==0);
       cantx=1;
      var cantidades = "<td class='cell100 column5 text-success'><input type='text'  class='form-control decimal' id='cant' name='cant'  value='"+cantx+"' style='width:60px;' /></td>";
