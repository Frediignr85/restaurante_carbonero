...
$(document).ready(function(){
    ...
    if($("#id_pestania_recepcion").val() == "insert"){
...
function senddata()
{
    ...
    var sexo = $('#sexo').val();
    var check_nacimiento = $("#check_nacimiento").val();
    ...
    if(errorAcumulado == 0){
        if(paciente_replace == "-1"){
            if(fecha_nacimiento == "" || sexo  == ""|| paciente ==""){
                var msg ='Complete los datos del paciente a ingresar.';
                var typeinfo = "Error";
                display_notify(typeinfo,msg,"");
                errorAcumulado++;
            }
	...
	var dataString ='process='+process+'&doctor='+doctor+'&fechaEntrada='+fechaEntrada+'&hora_entrada='+hora_entrada;
		dataString+='&emergencia='+emergencia+'&doctorReferido='+doctorReferido+'&paciente_replace='+paciente_replace+'&descripcionEvento='+descripcionEvento+'&pariente='+pariente;
        ...
        dataString+='&naci='+naci+'&fecha_nacimiento='+fecha_nacimiento+'&sexo='+sexo+'&check_nacimiento='+check_nacimiento+'&paciente='+paciente+'&id_recepcion_editar='+id_recepcion_editar+'&tipoOriginal='+tipoOriginal;
    if(errorAcumulado > 0){
